play-global-sound-command-description =  Toca um som global para um jogador específico ou para cada jogador conectado se nenhum jogador for especificado.

play-global-sound-command-help =  Tocando som global [volume] [user 1] ... [user n]
