reagent-name-juice-pomegranate = Suco de romã

reagent-desc-juice-pomegranate = O doce sabor da romã, menos a luxúria.

reagent-name-NNN = Néctar Naughty Nikko

reagent-desc-NNN = Um líquido branco, pegajoso e almiscarado que tem gosto de mirtilos.

reagent-name-boykisser-energy =  Energia Boykisser

reagent-desc-boykisser-energy = Bubbly, magenta brilhante, e cheira suspeitamente como um spray de corpo de 2009.
