...
chat-manager-entity-say-wrap-message = [BubbleHeader][Name]{ $entityName }[/Name][/BubbleHeader] { $verb } [font={ $fontType }  Tamanho={ $fontSize }]"[BubbleContent][color={ $textColor }]{ $message }[/color][/BubbleContent]"{ chat-manager-language-hint }[/font]

chat-manager-entity-say-bold-wrap-message = [BubbleHeader][Name]{ $entityName }[/Name][/BubbleHeader] { $verb } [font={ $fontType }  Tamanho={ $fontSize }]"[BubbleContent][bold][color={ $textColor }]{ $message }[/color][/bold][/BubbleContent]"{ chat-manager-language-hint }[/font]

chat-manager-entity-whisper-wrap-message = [font size=11][italic][BubbleHeader][Name]{ $entityName }[/Name][/BubbleHeader]  sussurros"[BubbleContent][color={ $textColor }]{ $message }[/color][/BubbleContent]"{ chat-manager-language-hint }[/italic][/font]

chat-manager-entity-whisper-unknown-wrap-message = [font size=11][italic][BubbleHeader] Alguém.[/BubbleHeader]  sussurros"[BubbleContent][color={ $textColor }]{ $message }[/color][/BubbleContent]"{ chat-manager-language-hint }[/italic][/font]
